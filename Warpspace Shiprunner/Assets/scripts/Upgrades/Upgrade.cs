...
public abstract class Upgrade
{
    ...
    public int spriteID;
    public Upgrade(Rarity rarity = Rarity.Junk, int value = 0, string name = "Junk", string description = "Does Nothing?", int spriteID = 0) {
...
public class EngineUpgrade : Upgrade {
    ...
    public EngineUpgrade() : this(Rarity.Common) { }
    public EngineUpgrade(Rarity tier = Rarity.Common) : base(tier, (int)tier*25, tier + " Fuel Pumps", "Increases Base Movement Speed.", 0) { modifier = (int)tier * 2; }
...
public class DamageUpgrade : Upgrade {
    public float modifier;
    public DamageUpgrade() : this(Rarity.Common) { }
    public DamageUpgrade(Rarity tier = Rarity.Common) : base(tier, (int)tier * 75, tier + " Improved Munitions", "Increases Attack Damage.", 1) { modifier = (int)tier * .5f; }
...
public class AttackUpgrade : Upgrade {
    public float modifier;
    public AttackUpgrade() : this(Rarity.Common) { }
    public AttackUpgrade(Rarity tier = Rarity.Common) : base(tier, (int)tier * 75, tier + " Cannon Loading", "Reduces Time Between Attacks.", 1) { modifier = 1 - (int)tier * .2f; }
...
public class DashUpgrade : Upgrade {
    public DashUpgrade() : base(Rarity.Uncommon, 125, "Dash Module", "Press [SHIFT] To Dash In Movement Direction", 0) { }
...
public class SuperDashUpgrade : Upgrade {
    public SuperDashUpgrade() : base(Rarity.Rare, 200, "Phasing Dash Module", "Press [SHIFT] To Dash In Movement Direction. You Are Invulnerable While Dashing.", 0) { }
...
public class BulletSpeedUpgrade : Upgrade {
    public float modifier;
    public BulletSpeedUpgrade() : this(Rarity.Common) { }
    public BulletSpeedUpgrade(Rarity tier = Rarity.Common) : base(tier, (int)tier * 10, tier + " Cannon Rifling", "Increases Velocity Of Attacks.", 1) { modifier = (int)tier * 5f; }
...
public class BulletPierceUpgrade : Upgrade {
    public BulletPierceUpgrade() : this(Rarity.Common) { }
    public BulletPierceUpgrade(Rarity tier = Rarity.Common):base(tier, (int)tier*75, tier + " Armor Piercing", "Increases Amount Of Enemies Pierced By Attacks.", 1) { }
...
public class PlayerRecoveryUpgrade : Upgrade {
    public float modifier;
    public PlayerRecoveryUpgrade() : this(Rarity.Common) { }
    public PlayerRecoveryUpgrade(Rarity tier = Rarity.Common) : base(tier, (int)tier * 25, tier + " Reactive Shielding", "Increases Amount Time Invulnerable After Taking Damage.",4) { modifier = rarity; }
...
public class EnrageUpgrade : Upgrade {
    public float modifier;
    public EnrageUpgrade() : this(Rarity.Common) { }
    public EnrageUpgrade(Rarity tier = Rarity.Common) : base(tier, (int)tier * 15, tier + " Defense Protocols", "Briefly Increases Attack Damage After Taking Damage.", 5) { modifier = rarity; }
...
public class ExplosiveHitUpgrade : Upgrade {
    public float modifier;
    public ExplosiveHitUpgrade() : this(Rarity.Common) { }
    public ExplosiveHitUpgrade(Rarity tier = Rarity.Common) : base(tier, (int)tier * 250, tier + " Explosive Shells", "Attacks Explode When Hitting Enemies.", 2) { modifier = (rarity - 1) / 2; }
...
public class ExplosiveKillUpgrade : Upgrade {
    public float modifier;
    public ExplosiveKillUpgrade() : this(Rarity.Common) { }
    public ExplosiveKillUpgrade(Rarity tier = Rarity.Common) : base(tier, (int)tier * 1000, "Virus: " + tier + " Reactor Meltdown Override", "Enemies Explode When Killed.", 2) { modifier = (rarity - 1) / 2; }
...
public class ExtraCannonUpgrade : Upgrade {
    ...
    public ExtraCannonUpgrade() : base(Rarity.Rare,  200, "Extra Cannon", "Gain A Second Cannon, But Reduces Attack Damage.", 1) {}
...
public class ExtraKillTrigger : Upgrade {
    public ExtraKillTrigger() : base(Rarity.Rare, 200, "Virus: Trojan Payload", "Doubles The Effects Of Other Virus (On Kill) Upgrades.", 6) { }
...
public class DamageOnKill : Upgrade {
    ...
    public DamageOnKill() : this(Rarity.Common) { }
    public DamageOnKill(Rarity tier = Rarity.Common) : base(tier, (int)tier * 50, "Virus: " + tier + " Defense Exploit", "Briefly Increases Attack Damage On Enemy Kill.", 6) { modifier = rarity; }
...
public class CreditsOnKill : Upgrade {
    ...
    public CreditsOnKill() : this(Rarity.Common) { }
    public CreditsOnKill(Rarity tier = Rarity.Common) : base(tier, (int)tier * 75, "Virus: " + tier + " Credit Scraper", "Gain Extra Credits On Enemy Kill.", 3) { modifier = rarity; }
...
public class HealthOnKill : Upgrade {
    public HealthOnKill() : base(Rarity.Rare, 750, "Virus: Shielding Data Extraction", "Gain A Small Amount Of Health On Enemy Kill.", 8) { }
...
public class VirusDamageBoost : Upgrade {
    public VirusDamageBoost() : base(Rarity.Rare, 150, "Virus: Fatal Error", "Increasse Attack Damage For Each Equipped Virus.", 6) { }
...
public class PoisonUpgrade : Upgrade {
    float modifier;
    public PoisonUpgrade() : this(Rarity.Common) { }
    public PoisonUpgrade(Rarity tier = Rarity.Common) : base(tier, (int)tier * 50, tier + " Corrosive Rounds", "Attacks Inflict Damaging Poison.", 7) { modifier = rarity + 1; }
...
public class HealthUpgrade : Upgrade {
    float modifier;
    public HealthUpgrade() : this(Rarity.Common) { }
    public HealthUpgrade(Rarity tier = Rarity.Common) : base(tier, (int)tier * 75, tier + " Backup Shields", "Increases Maximum Health.", 4) { modifier = rarity * 2; }
...
public class CreditsWhenHit : Upgrade {
    float modifier;
    public CreditsWhenHit() : this(Rarity.Common) { }
    public CreditsWhenHit(Rarity tier = Rarity.Common) : base(tier, (int)tier*25, tier + " Insurance Plan", "Gain Credits After Taking Damage.", 3) { modifier = rarity * 5; }
...
public class RailgunUpgrade : Upgrade {
    public RailgunUpgrade() : base(Rarity.Uncommon, 100, "Railcannon Adapter", "Greatly Increases Attack Damage And Velocity. Increases Time Between Attacks.", 5) { }
...
public class GattlingGunUpgrade : Upgrade {
    public GattlingGunUpgrade(): base(Rarity.Uncommon, 100, "Gattling Adapter", "Greatly Decreases Time Between And Accuracy Of Attacks.", 1) { }
